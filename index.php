    ...
    <div class="container mt-5 py-5">
        ...
        <div class="mt-big text-center">
            <p class="mb-1 text-muted fst-italic">
                Pour aller directement à la page de mes projets, cliquez sur le bouton ci-dessous :
            </p>
            <a href="projects.php" class="btn btn-primary btn-lg mt-3">Voir mes projets</a>
        </div>
    </div>
</main>
